...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-dark-900 relative overflow-hidden">
            ...
            <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-nexus-500/10 rounded-full blur-3xl"></div>
            ...
            <div className="glass p-8 rounded-2xl shadow-nexus-lg w-full max-w-md animate-fade-in-up relative z-10">
                ...
                <p className="text-dark-400 mt-6 text-center text-sm">
                    Already have an account? <Link to="/login" className="text-nexus-400 hover:text-nexus-300 font-medium transition-smooth">Sign in</Link>
                </p>
            </div>
        </div>
    )
